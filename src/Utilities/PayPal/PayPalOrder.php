...
class PayPalOrder
{
    ...
    {
        // Crear la primera purchase_unit
    ...
    {
        // Asegurar que purchase_units existe
        if (!isset($this->_body["purchase_units"][0])) {
            $this->_body["purchase_units"][0] = $this->_purchaseUnitTemplate;
        }
